...
function snapshot(){
  return {v:SAVE_V,order,idx,port,cash,xp,streak,best,focus,
    owned,appLeft,appLive,sessionsLeft,month,monthPnl,peak,maxDD,conv,gameOver,tutOn,genSeed,carTier,homeTier,careerStage,rep,contacts,trips,research,arc,aum,aumStart,aumPeak,retHist,fundClosed,
