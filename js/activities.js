...
const ENCOUNTERS=[
 ...
 {id:'block', w:2, min:0, n:'The road is closed',
  d:'Roadworks, and a diversion that eats the afternoon.',
  fx:()=>{trips=Math.max(0,trips-1); return 'A trip gone.';}}
];
