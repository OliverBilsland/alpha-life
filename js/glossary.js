...
/* ---------- running money ---------- */
 ...
 convert:{g:'Security', n:'Convertible bond',
  one:'A loan to a company that you can swap for shares if the company does well.',
  why:'It pays like a loan when you are wrong and like ownership when you are right. You never get it cheaply, because you are being sold protection and upside at once.'},
 merger:{g:'Security', n:'Merger arbitrage',
  one:'A company has agreed to be bought. You buy its shares slightly below the offer price and collect the difference if the deal completes.',
  why:'Lots of small wins and occasional disasters. The question stops being "is this a good business" and becomes "will this deal survive the regulators".'},
